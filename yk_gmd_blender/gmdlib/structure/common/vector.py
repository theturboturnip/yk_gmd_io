...
def Vec3Unpacker_of(float_type: BaseUnpacker[float]):
    return ValueAdaptor[Sequence[float], mathutils.Vector](mathutils.Vector,
...
QuatUnpacker = ValueAdaptor[Sequence[float], mathutils.Quaternion](mathutils.Quaternion,
