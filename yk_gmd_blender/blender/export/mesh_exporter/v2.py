...
from yk_gmd_blender.blender.export.mesh_exporter.index_juggling import dedupe_loops, SkinnedSubmesh, \
    convert_meshloop_tris_to_unskinned_submeshes, Submesh, convert_meshloop_tris_to_tsubmeshes, MeshLoopTri, \
    MeshLoopIdx, DedupedVertIdx, MaterialVertIdx
