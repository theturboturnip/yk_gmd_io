...
class GMDVertexBufferLayout:
    ...
    def unpack_vertices(self, vertex_big_endian: bool, vertex_count: int, data: bytes, start_offset=0) -> List[GMDVertex]:
        format_prefix = ">" if vertex_big_endian else "<"
        bpv = self.calc_bytes_per_vertex()
        format_strings = {}
        for name in ["pos", "weights", "normal", "tangent", "col0", "col1", "uv0", "uv1"]:
            format_strings[name] = format_prefix + self.get_type_format_string(name)
        ...
        for i in range(vertex_count):
            ...
            if self.weights_type:
                ...
                bone_format = format_prefix + "BBBB"
                bone_bytes = struct.unpack_from(bone_format, vtx_data, offset=offset)
                vertex.weights = (
                ...
                offset += struct.calcsize(bone_format)
            if self.normal_type:
    ...
    def pack_vertices(self, vertex_big_endian: bool, vertices: List[GMDVertex]) -> bytes:
        format_prefix = ">" if vertex_big_endian else "<"
        ...
        for vertex in vertices:
            ...
            if self.weights_type:
                ...
                bs += struct.pack(format_prefix + "BBBB",
            ...
            if self.normal_type:
                ...
                if "B" in format_string:
                    ...
                    bs += struct.pack(format_prefix + "BBBB", normal[0], normal[1], normal[2], normal[3])
                else:
            ...
            if self.tangent_type:
                ...
                if "B" in format_string:
                    ...
                    bs += struct.pack(format_prefix + "BBBB", tangent[0], tangent[1], tangent[2], tangent[3])
                else:
            ...
            if self.col0_type:
                ...
                if "B" in format_string:
                    ...
                    bs += struct.pack(format_prefix + "BBBB", col0[0], col0[1], col0[2], col0[3])
                else:
            ...
            if self.col1_type:
                ...
                if "B" in format_string:
                    ...
                    bs += struct.pack(format_prefix + "BBBB", col1[0], col1[1], col1[2], col1[3])
                else:
